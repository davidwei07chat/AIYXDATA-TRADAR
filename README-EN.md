...
<a href="https://github.com/AIYXDATA/AIYXDATA-TRADAR" title="AIYXDATA-TRADAR">
  <img src="/_image/banner.webp" alt="AIYXDATA-TRADAR Banner" width="80%">
</a>

Deploy in <strong>30 seconds</strong> — Say goodbye to endless scrolling, only see the news you truly care about

<a href="https://trendshift.io/repositories/14726" target="_blank"><img src="https://trendshift.io/api/badge/repositories/14726" alt="AIYXDATA%2FAIYXDATA-TRADAR | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

[![GitHub Stars](https://img.shields.io/github/stars/AIYXDATA/AIYXDATA-TRADAR?style=flat-square&logo=github&color=yellow)](https://github.com/AIYXDATA/AIYXDATA-TRADAR/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/AIYXDATA/AIYXDATA-TRADAR?style=flat-square&logo=github&color=blue)](https://github.com/AIYXDATA/AIYXDATA-TRADAR/network/members)
[![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg?style=flat-square)](LICENSE)
[![Version](https://img.shields.io/badge/version-v6.0.0-blue.svg)](https://github.com/AIYXDATA/AIYXDATA-TRADAR)
[![MCP](https://img.shields.io/badge/MCP-v4.0.0-green.svg)](https://github.com/AIYXDATA/AIYXDATA-TRADAR)
[![RSS](https://img.shields.io/badge/RSS-Feed_Support-orange.svg?style=flat-square&logo=rss&logoColor=white)](https://github.com/AIYXDATA/AIYXDATA-TRADAR)
[![AI Translation](https://img.shields.io/badge/AI-Multi--Language-purple.svg?style=flat-square)](https://github.com/AIYXDATA/AIYXDATA-TRADAR)
...
[![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-Automation-2088FF?style=flat-square&logo=github-actions&logoColor=white)](https://github.com/AIYXDATA/AIYXDATA-TRADAR)
[![GitHub Pages](https://img.shields.io/badge/GitHub_Pages-Deployment-4285F4?style=flat-square&logo=github&logoColor=white)](https://AIYXDATA.github.io/AIYXDATA-TRADAR)
[![Docker](https://img.shields.io/badge/Docker-Deployment-2496ED?style=flat-square&logo=docker&logoColor=white)](https://hub.docker.com/r/wantcat/aiyxdata_tradar)
...
>
> Whether your name is on the list or not, your every bit of support is the cornerstone that allows AIYXDATA-TRADAR to be where it is today. 🙏
...
| *W | 6 | 2025.11.13 | |
| *凯 | 1 | 2025.11.13 | |
| 对*. | 1 | 2025.11.13 | Thanks for AIYXDATA-TRADAR |
| s*y | 1 | 2025.11.13 | |
| **翔 | 10 | 2025.11.13 | Wish I found it earlier |
| *韦 | 9.9 | 2025.11.13 | AIYXDATA-TRADAR is awesome |
...
### ❤️ Find it useful? Support AIYXDATA-TRADAR

> If AIYXDATA-TRADAR has captured value for you, give it some fuel to keep evolving
>
...
>**📌 Check Latest Updates**: **[Original Repository Changelog](https://github.com/AIYXDATA/AIYXDATA-TRADAR?tab=readme-ov-file#-changelog)**:
...
- **Code reuse**: Batch utilities now imported from aiyxdata_tradar core instead of duplicated
...
- Added visual configuration editor for AIYXDATA-TRADAR
...
- **New check_version Tool**: Check AIYXDATA-TRADAR and MCP Server version updates simultaneously
...
- Added independent MCP service image `wantcat/aiyxdata_tradar-mcp`
...
- Control via `manage.py` commands: `docker exec -it aiyxdata_tradar python manage.py start_webserver`
...
**🐛 Bug Fix**
- Fixed issue where `ntfy_server_url` in `config.yaml` was ignored ([#345](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/345))
...
> Thanks to [nidaye996](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/98) for discovering the UX issue
...
- Fixed email notification config check being missed ([#88](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/88))
...
- Officially released official Docker image wantcat/aiyxdata_tradar, supports multi-architecture
...
https://github.com/AIYXDATA/AIYXDATA-TRADAR/blob/master/.github/workflows/crawler.yml
...
👉 **Try it online**: [https://AIYXDATA.github.io/AIYXDATA-TRADAR/](https://AIYXDATA.github.io/AIYXDATA-TRADAR/)
...
No longer controlled by platform algorithms, AIYXDATA-TRADAR reorganizes all trending searches
...
>
> **💡 Tip**: Enable GitHub Pages for an online URL. Go to Settings → Pages to enable. [Preview Effect](https://AIYXDATA.github.io/AIYXDATA-TRADAR/)
>
...
> **Reminder**: You should first **[check the latest official documentation](https://github.com/AIYXDATA/AIYXDATA-TRADAR?tab=readme-ov-file)** to ensure the configuration steps are up to date.
...
### 1️⃣ Step 1: Get project code
   ...
   > - Using Fork may cause runtime issues, see [Issue #606](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/606)
...
3. Click "Add" → Name input "AIYXDATA-TRADAR"
...
Method 1 discovered and suggested by **ziventian**, thanks to them. Default is personal push, group push can be configured via [#97](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/97)
...
7. Message title fill "AIYXDATA-TRADAR Trending Monitor"
...
8. Message title fill "AIYXDATA-TRADAR Trending Monitor"
...
>
> **Feedback Notice**:
> - If you successfully test with **other email providers**, please open an [Issue](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues) to let us know, we'll add to support list
> - If above email configurations are incorrect or unusable, please also open an [Issue](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues) for feedback to help improve the project
>
> **Special Thanks**:
> - Thanks to [@DYZYD](https://github.com/DYZYD) for contributing 189 Mail (189.cn) configuration and completing self-send-receive testing ([#291](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/291))
> - Thanks to [@longzhenren](https://github.com/longzhenren) for contributing Aliyun Mail (aliyun.com) configuration and completing testing ([#344](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/344))
> - Thanks to [@ACANX](https://github.com/ACANX) for contributing Yandex Mail (yandex.com) configuration and completing testing ([#663](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/663))
> - Thanks to [@Sleepy-Tianhao](https://github.com/Sleepy-Tianhao) for contributing iCloud Mail (icloud.com) configuration and completing testing ([#728](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/728))
...
2. **Subscribe to Topic** (choose a hard-to-guess name):
   ```
   Suggested format: aiyxdata_tradar-{your initials}-{random numbers}

   Cannot use Chinese

   ✅ Good example: aiyxdata_tradar-zs-8492
...
**Configure AIYXDATA-TRADAR**:
```yaml
NTFY_SERVER_URL: https://ntfy.yourdomain.com
NTFY_TOPIC: aiyxdata_tradar-alerts  # Self-hosting can use simple name
...
If you choose a random, sufficiently long name (like `aiyxdata_tradar-zs-8492-news`), brute force is nearly impossible:
...
3. **Fill in App Information**:
   - **App Name**: Enter app name (e.g., `AIYXDATA-TRADAR` or `Hot News Monitor`)
...
3. **Configure to AIYXDATA-TRADAR**:
...
# Custom format
{"text": "{content}", "username": "AIYXDATA-TRADAR"}
```
...
### 3️⃣ Step 3: Manual Test News Push
   ...
   **How to find your Actions page**:
   ...
   - **Method 2**: Direct access `https://github.com/YourUsername/AIYXDATA-TRADAR/actions`

   **Example comparison**:
   - ❌ Author's project: `https://github.com/AIYXDATA/AIYXDATA-TRADAR/actions`
   - ✅ Your project: `https://github.com/YourUsername/AIYXDATA-TRADAR/actions`

   **Testing steps**:
   1. Enter your project's Actions page
   2. Find **"Hot News Crawler"** and click in
      - If you don't see this text, refer to [#109](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/109) to solve
...
### 5️⃣ Step 5: GitHub Actions Check-In & Remote Cloud Storage
   ...
   **Required Configuration (4 items):**
   ...
   |------|----------------------------|
   | `S3_BUCKET_NAME` | Bucket name (e.g., `aiyxdata_tradar-data`) |
   ...
   **How to Get Credentials (Using Cloudflare R2 as Example):**
   ...
   2. Select `R2` in left menu → Click `Create Bucket` → Enter name (e.g., `aiyxdata_tradar-data`)
...
### 7️⃣ Step 7: 🎉 Deployment Success!
   ...
   Congratulations! Now you can start enjoying the efficient information flow brought by AIYXDATA-TRADAR.
...
### 8️⃣ Step 8: Advanced: Choose Your AI Assistant
   ...
   AIYXDATA-TRADAR provides two ways to use AI to meet different needs:
...
> 💡 **Shortcut**: If you don't know how to read source code, you can copy from others' organized [Platform Configuration Summary](https://github.com/AIYXDATA/AIYXDATA-TRADAR/issues/95)
...
AIYXDATA-TRADAR provides two independent Docker images, deploy according to your needs:

| Image Name | Purpose | Description |
|---------|------|------|
| `wantcat/aiyxdata_tradar` | News Push Service | Scheduled news crawling, push notifications (Required) |
| `wantcat/aiyxdata_tradar-mcp` | AI Analysis Service | MCP protocol support, AI dialogue analysis (Optional) |

> 💡 **Recommendations**:
> - Only need push functionality: Deploy `wantcat/aiyxdata_tradar` image only
...
1. **Create Project Directory and Config**:
   ...
   **Method 1-A: Using git clone (Recommended, Simplest)**
   ...
   git clone https://github.com/AIYXDATA/AIYXDATA-TRADAR.git
   cd AIYXDATA-TRADAR
   ```
   ...
   **Method 1-B: Using wget to download config files**
   ...
   mkdir -p aiyxdata_tradar/{config,docker}
   cd aiyxdata_tradar

   # Download config file templates
   wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/config/config.yaml -P config/
   wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/config/frequency_words.txt -P config/
   wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/config/ai_analysis_prompt.txt -P config/

   # Download docker compose config
   wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/docker/.env -P docker/
   wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/docker/docker-compose.yml -P docker/
   ```
...
3. **Start Service**:
   ...
   **Option A: Start All Services (Push + AI Analysis)**
   ...
   # Start all services (aiyxdata_tradar + aiyxdata_tradar-mcp)
   docker compose up -d
   ```

   **Option B: Start News Push Service Only**
   ```bash
   # Start aiyxdata_tradar only (scheduled crawling and push)
   docker compose pull aiyxdata_tradar
   docker compose up -d aiyxdata_tradar
   ```

   **Option C: Start MCP AI Analysis Service Only**
   ```bash
   # Start aiyxdata_tradar-mcp only (AI analysis interface)
   docker compose pull aiyxdata_tradar-mcp
   docker compose up -d aiyxdata_tradar-mcp
   ```

   > 💡 **Tips**:
   > - Most users only need to start `aiyxdata_tradar` for news push functionality
   > - Only need to start `aiyxdata_tradar-mcp` when using ChatGPT/Gemini for AI dialogue analysis
...
4. **Check Running Status**:
   ...
   docker logs -f aiyxdata_tradar-mcp

   # View all container status
   docker ps | grep aiyxdata_tradar

   # Stop specific service
   docker compose stop aiyxdata_tradar      # Stop push service
   docker compose stop aiyxdata_tradar-mcp  # Stop MCP service
   ```
...
docker compose build aiyxdata_tradar
docker compose up -d aiyxdata_tradar

# Option C: Build and start MCP AI analysis service only
docker compose build aiyxdata_tradar-mcp
docker compose up -d aiyxdata_tradar-mcp
```
...
docker pull wantcat/aiyxdata_tradar:latest
docker pull wantcat/aiyxdata_tradar-mcp:latest
docker compose down
docker compose up -d
...
| Image Name | Purpose | Description |
|---------|------|---------|
| `wantcat/aiyxdata_tradar` | News Push Service | Scheduled news crawling, push notifications |
| `wantcat/aiyxdata_tradar-mcp` | MCP Service | AI analysis features (optional) |
...
# View real-time logs
docker exec -it aiyxdata_tradar python manage.py logs

# Display current config
docker exec -it aiyxdata_tradar python manage.py config

# Display output files
docker exec -it aiyxdata_tradar python manage.py files

# Web server management (for browser access to generated reports)
docker exec -it aiyxdata_tradar python manage.py start_webserver   # Start web server
docker exec -it aiyxdata_tradar python manage.py stop_webserver    # Stop web server
docker exec -it aiyxdata_tradar python manage.py webserver_status  # Check web server status

# View help info
docker exec -it aiyxdata_tradar python manage.py help

# Restart container
docker restart aiyxdata_tradar

# Stop container
docker stop aiyxdata_tradar

# Remove container (keep data)
docker rm aiyxdata_tradar
```
...
AIYXDATA-TRADAR generates daily summary HTML reports to two locations simultaneously:
...
# 1. Start web server
docker exec -it aiyxdata_tradar python manage.py start_webserver
# 2. Access in browser
...
docker inspect aiyxdata_tradar

# View container logs
docker logs --tail 100 aiyxdata_tradar

# Enter container for debugging
docker exec -it aiyxdata_tradar /bin/bash

# Verify config files
docker exec -it aiyxdata_tradar ls -la /app/config/
```
...
```mermaid
flowchart TB
    subgraph aiyxdata_tradar["aiyxdata_tradar"]
        A1[Scheduled News Fetching]
        A2[Push Notifications]
    end
    
    subgraph aiyxdata_tradar-mcp["aiyxdata_tradar-mcp"]
        B1[127.0.0.1:3333]
        B2[AI Analysis API]
    end
    ...
    aiyxdata_tradar --> shared
    aiyxdata_tradar-mcp --> shared
```
...
git clone https://github.com/AIYXDATA/AIYXDATA-TRADAR.git
cd AIYXDATA-TRADAR/docker
docker compose up -d

# Method 2: Download docker-compose.yml separately
mkdir aiyxdata_tradar && cd aiyxdata_tradar
wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/docker/docker-compose.yml
wget https://raw.githubusercontent.com/AIYXDATA/AIYXDATA-TRADAR/master/docker/.env
...
```bash
# Linux/Mac
docker run -d --name aiyxdata_tradar-mcp \
  -p 127.0.0.1:3333:3333 \
  -v $(pwd)/config:/app/config:ro \
  -v $(pwd)/output:/app/output:ro \
  -e TZ=Asia/Shanghai \
  wantcat/aiyxdata_tradar-mcp:latest
...
Hacker News (5 items):
  1. [Hacker News] Launch HN: AIYXDATA-TRADAR...
  ...
```
...
AIYXDATA-TRADAR v3.0.0 added **MCP (Model Context Protocol)** based AI analysis feature, allowing natural language conversations with news data for deep analysis.
...
AIYXDATA-TRADAR MCP service supports standard Model Context Protocol (MCP), can connect to various AI clients supporting MCP for smart analysis.

### Supported Clients

**Note**:
- Replace `/path/to/AIYXDATA-TRADAR` with your actual project path
- Windows paths use double backslashes: `C:\\Users\\YourName\\AIYXDATA-TRADAR`
   ...
   ```json
   {
     "mcpServers": {
       "aiyxdata_tradar": {
         ...
         "description": "AIYXDATA-TRADAR News Trending Aggregation Analysis"
       }
     }
   }
   ```
...
1. **Start AIYXDATA-TRADAR HTTP Service**:
   ```bash
   # Windows
   start-http.bat
...
Any client supporting Model Context Protocol can connect to AIYXDATA-TRADAR:
...
**Notes**:
- Replace `/path/to/AIYXDATA-TRADAR` with actual project path
...
- **Project Address**: https://github.com/AIYXDATA/ai-code-context-helper
...
- https://github.com/AIYXDATA/mao-map

> Bilibili Comment Data Visualization Analysis Software

- https://github.com/AIYXDATA/bilibili-comment-analyzer


[![Star History Chart](https://api.star-history.com/svg?repos=AIYXDATA/AIYXDATA-TRADAR&type=Date)](https://www.star-history.com/#AIYXDATA/AIYXDATA-TRADAR&Date)
