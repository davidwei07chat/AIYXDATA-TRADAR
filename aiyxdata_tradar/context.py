...
from aiyxdata_tradar.core import (
...
from aiyxdata_tradar.report import (
    clean_title,
    prepare_report_data,
    generate_html_report,
)
from aiyxdata_tradar.report.html_v2 import render_html_content_v2
from aiyxdata_tradar.notification import (
    render_feishu_content,
    render_dingtalk_content,
    split_content_into_batches,
    NotificationDispatcher,
)
from aiyxdata_tradar.ai import AITranslator
from aiyxdata_tradar.storage import get_storage_manager
...
class AppContext:
    ...
    def render_html(
        ...
        """渲染HTML内容 (使用 V2 明亮科技风)"""
        return render_html_content_v2(
